...
import { getContext, executeAsync } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/h3/dist/index.mjs';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DlKA-vyX.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-wtGFz1SB.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DJpE4Qxp.mjs'));
