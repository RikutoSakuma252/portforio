...
import { u as useHead } from "./v3-DtIER5BK.js";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/ofetch/dist/node.mjs";
import "#internal/nuxt/paths";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/hookable/dist/index.mjs";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/unctx/dist/index.mjs";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/h3/dist/index.mjs";
import "vue-router";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/defu/dist/defu.mjs";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/ufo/dist/index.mjs";
import "C:/claude/portfolio2/sites/site-03-atelier-blanc/node_modules/@unhead/vue/dist/index.mjs";
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { inView } = useInView();
    const services = [
      { name: "Cut", jp: "カット", price: "¥8,800〜", duration: "約60分", desc: "骨格・髪質を診断し、あなたに最も似合うフォルムを提案します。" },
      { name: "Color", jp: "カラー", price: "¥12,100〜", duration: "約120分", desc: "繊細なカラーリングで、肌トーンを美しく引き立てる色を選びます。" },
      { name: "Perm", jp: "パーマ", price: "¥14,300〜", duration: "約150分", desc: "ダメージを最小限に抑えた薬剤で、自然なウェーブを。" },
      { name: "Treatment", jp: "トリートメント", price: "¥5,500〜", duration: "約45分", desc: "髪の内部から補修し、しなやかな艶と手触りを取り戻します。" }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "service",
...
//# sourceMappingURL=index-DlKA-vyX.js.map
